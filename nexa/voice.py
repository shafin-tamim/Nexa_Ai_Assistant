...
def speak(text):
    ...
    try:
        ...
        logger.error(f"Error in speak function: {type(e).__name__}: {str(e)}")
...
def take_command():
    ...
    try:
        ...
        logger.error(f"Unexpected error in voice recognition: {type(e).__name__}: {str(e)}")
        return "none"
...
def greet():
    """Alias for wish_me for backward compatibility."""
    wish_me()
